...
public class EventService {
    ...
    public Event modify(long id, EventModifyInDto eventModifyInDto, Location location, List<Artist> artists) throws EventNotFoundException {
        Event eventExisting = eventRepository.findById(id)
                .orElseThrow(EventNotFoundException::new);

        modelMapper.map(eventModifyInDto, eventExisting);
