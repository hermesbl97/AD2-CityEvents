...
public class EventControllerTests {
    ...
    public void testAddEvent() throws Exception {
        ...
        Location location = new Location(1,"La Romareda", "Estadio de fútbol", "Estadio", "Isabel la Católica",
                50009, LocalDate.of(2025,2,1), true, 65, 33, "Sevilla", null);
    ...
    public void testModifyEvent() throws Exception {
        ...
        when(locationService.findById(1L)).thenReturn(locationRequest);
        ...
        verify(eventService, times(1)).modify(eq(1L),any(EventModifyInDto.class), eq(locationRequest), eq(artistsRequest));
    }
